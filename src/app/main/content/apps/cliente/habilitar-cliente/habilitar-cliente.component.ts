        ...
        content: [
          {
            stack: [
              {
                text: 'Santiago, 21 de Julio del 2020',
                style: 'date'
              },
              {
            ...
            stack: [
              {
                text: [
                    ...
                    { text: 'EL INVERSIONISTA ASUME DESDE YA LA OBLIGACIÓN DE PROVEER LOS FONDOS AL BANCO FALABELLA EN LOS TÉRMINOS EXPUESTOS, PARA EFECTUAR LAS OPERACIONES QUE ÉSTE INSTRUYA. EN CASO CONTRARIO, EL BANCO COMO MANDATARIO QUEDA LIBERADO DE TODA OBLIGACIÓN DE REALIZAR CUALQUIER INVERSIÓN REQUERIDA, NO ASUMIENDO EL BANCO RESPONSABILIDAD ALGUNA EN EL CUMPLIMIENTO EN EL PRESENTE MANDATO.'},			  
                    { text: 'EL INVERSIONISTA DECLARA CONOCER LAS SOLICITUDES DE INVERSIÓN, SU CONTENIDO Y EL TEXTO DE LOS CONTRATOS DE SUSCRIPCIÓN DE CUOTAS DE FONDOS MUTUOS, TABLAS DE COSTOS Y DEMÁS ANTECEDENTES ATINGENTES. ASIMISMO, EXPRESA CONOCER LOS RESPECTIVOS REGLAMENTOS INTERNOS DE LOS FONDOS MUTUOS DE LAS ADMINISTRADORAS, ASÍ COMO SUS PORCENTAJES DE REMUNERACIONES, COMISIONES Y GASTOS.'},	  
                    { text: 'EXPRESA EL CLIENTE TAMBIÉN, CONOCER QUE POR LA NATURALEZA DE LOS FONDOS MUTUOS, ESTOS NO PUEDEN GARANTIZAR UNA DETERMINADA RENTABILIDAD, SIENDO ÉSTA ESENCIALMENTE VARIABLE E INDETERMINADA. TAMBIÉN DECLARA CONOCER QUE EL VALOR DE LAS CUOTAS DE LOS FONDOS MUTUOS, PUEDEN AUMENTAR O DISMINUIR COMO CONSECUENCIA DE FLUCTUACIONES PROPIAS DEL MERCADO. DECLARA ASIMISMO CONOCER QUE LAS OPERACIONES SE REALIZARÁN CON LAS ADMINISTRADORAS Y QUE NO SON DEPÓSITOS NI OBLIGACIONES DEL BANCO FALABELLA Y NO COMPROMETEN PATRIMONIALMENTE A ESTA ÚLTIMA INSTITUCIÓN BANCARIA.'},
